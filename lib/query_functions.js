...
// Adds an order for a particular restaurant
// const addOrderForRestaurant = function (db, totalAmount, restaurantIdForOrder, userId) {
//   return db.query(`INSERT INTO orders (date_time_ordered_created, total_amount, restaurant_id, user_id)
...
module.exports.addOrderForAny = addOrderForAny;
